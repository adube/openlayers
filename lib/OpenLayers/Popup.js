...
OpenLayers.Popup = OpenLayers.Class({
    ...
    */
    initialize:function(id, lonlat, contentSize, contentHTML, closeBox, closeBoxCallback) {
        ...
        this.div = OpenLayers.Util.createDiv({id: this.id, overflow: "hidden"});
        this.div.className = this.displayClass;

        this.groupDiv = OpenLayers.Util.createDiv({id:  this.id + "_GroupDiv",
            position: "relative", overflow: "hidden"});
        this.contentDiv = OpenLayers.Util.createDiv({position: "relative",
            id: this.div.id + "_contentDiv", size: this.contentSize.clone()});
