...
OpenLayers.Tile.Image.IFrame = {
    ...
    initImgDiv: function() {
        ...
        if (this.useIFrame) {
            if (this.imgDiv == null) {
                ...
                OpenLayers.Util.modifyDOMElement(eventPane, {
                    pixel: new OpenLayers.Pixel(0,0),
                    size: this.layer.getImageSize(), position: "absolute"
                )};

                OpenLayers.Util.modifyDOMElement(this.imgDiv, {id: this.id,
                    size: this.layer.getImageSize(), position: "relative"});
    ...
    createIFrame: function() {
        ...
        OpenLayers.Util.modifyDOMElement(iframe, {id: id, position: "absolute",
            pixel: new OpenLayers.Pixel(0,0), size: this.layer.getImageSize()});
