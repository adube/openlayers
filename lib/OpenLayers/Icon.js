...
OpenLayers.Icon = OpenLayers.Class({
    ...
    initialize: function(url, size, offset, calculateOffset) {
        ...
        this.imageDiv = OpenLayers.Util.createAlphaImageDiv({id: id});
    },
    ...
    draw: function(px) {
        OpenLayers.Util.modifyAlphaImageDiv(this.imageDiv, {
            size: this.size, imageURL: this.url, position: "absolute"});
        this.moveTo(px);
    ...
    setOpacity: function(opacity) {
        OpenLayers.Util.modifyAlphaImageDiv(this.imageDiv, {opacity: opacity});
    },
